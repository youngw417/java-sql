...
```SQL
SELECT c.contact_name, count(o.order_id) as cd
FROM customers c JOIN orders o
ON o.customer_id = c.customer_id
...
```SQL
SELECT c.city, count(o.order_id) as cd
FROM customers c JOIN orders o
ON o.customer_id = c.customer_id
GROUP BY c.city
ORDER BY c.city;
...
| person_id  |person Name |  Living_id |            |            |            |            |            |            |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|
|    1       |   Jane     |    1       |            |            |            |            |            |            |
|    2       |   Bob      |    2       |            |            |            |            |            |            |
|    3       |   Sam      |    3       |            |            |            |            |            |            |
...
| pet_id     |pet name    | pet type   | owner_id   |            |            |            |            |            |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| 1          |  Ellie     |     Dog    |      1     |            |            |            |            |            |
| 2          |  Tiger     |     Cat    |      1     |            |            |            |            |            |
| 3          |  Toby      |     Turtle |      1     |            |            |            |            |            |
...
| living_id  | fence yard |City dweller |            |            |            |            |            |            |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|
|    1       |     No     |     Yes    |            |            |            |            |            |            |
|    2       |     No     |     No     |            |            |            |            |            |            |
|    3       |     Yes    |     No     |            |            |            |            |            |            |
